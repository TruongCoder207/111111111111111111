...
def banner():
    ...
    print(w+d+"      ((("+w+b+"@@@@@@@@@@@@@@@@"+w+d+")))    "+w+b+"NXT BOTNET - version 1.0")
    print(w+b+"      \@@/"+r+",:::,"+w+b+"\/"+r+",:::,"+w+b+"\@@       "+w+"------------------")
    print(w+b+"     /@@@|"+r+":::::"+w+b+"||"+r+":::::"+w+b+"|@@@\\     "+w+"Author by "+y+"@NxtDeveloper")
    print(w+b+"    / @@@\\"+r+"':::'"+w+b+"/\\"+r+"':::'"+w+b+"/@@@ \\    "+w+"Tool Botnet Ransomewe By NXT")
    print(w+b+"   /  /@@@@@@@//\\\@@@@@@@\  \\   "+w+"SHUT DOWN NXT")
    print(w+b+"  (  /  '@@@@@====@@@@@'  \  )  "+w+"NXT DEVELOPER PROGRAMMER")
    print(w+b+"   \(     /          \     )/")
    print(w+b+"     \   (            )   /")
    print(w+b+"          \          /"+w)
